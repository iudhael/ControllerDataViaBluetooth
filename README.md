...
Connexion d’une manette (cas d'une manette PS5) à un ordinateur via Bluetooth, puis réception des valeurs des boutons et des sticks analogiques sur l'ordinateur.


Pour connecter une manette PS5 à un ordinateur Linux via Bluetooth et recevoir les valeurs des boutons et des sticks analogiques, suivez les étapes suivantes :
...
2.   Installez la bibliothèque approxeng.input, qui permet de lire les entrées de la manette :
   ...
   Cela configurera votre système pour recevoir les valeurs de la manette PS5 sur un système Linux.
